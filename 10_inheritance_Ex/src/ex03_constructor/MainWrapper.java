 ...
 * 3. 서브 클래스의 생성자가 호출될 때는 "반드시" 슈퍼클래스의 생성자를 "먼저" 호출해야 한다.
 * 4. 만약 서브클래스의 생성자에서 슈퍼클래스의 생성자를 호출하지 않으면 Java에 의해서 슈퍼클래스의 "디폴트생성자"가 호출된다.
 * 5.서브 클래스의 생성자에서  슈퍼클래스의  생성자를 호출하는 방법은 super()이다.
 */
