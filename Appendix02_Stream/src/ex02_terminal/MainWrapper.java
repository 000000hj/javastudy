...
public class MainWrapper {
  ...
  {
    // 통계 계산
 //   IntStream isStream=IntStream.range(1, 6);//1,2,3,4,5
    System.out.println("합계"+IntStream.range(1, 6).sum());
    System.err.println("평균"+IntStream.range(1, 6).average().getAsDouble());
  ...
  public static void ex02()
  {
    ...
    //Stream -> List
    List<String> list =stream.collect(Collectors.toList());//통째로 외워도 됨. 아 - 주 좋아
