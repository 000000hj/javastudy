...
public class MainWrapper {
  ...
  public static void main(String[] args) {
    ...
    try {
    Bakery bakery = new Bakery(100, 10000);  // 빵 100개, 빵 가격 2000원, 빵집에 10000원 있다.
    
    Customer customer = new Customer(10000);  // 빵 0개, 10000원을 가진 고객
    
   // customer.buy(bakery, 3, 10000);  // bakery에서 빵 3개 구매를 위해서 10000원을 냈다.
    //customer.buy(bakery, 3, 0);  // bakery에서 빵 3개 구매를 위해서 10000원을 냈다.
    customer.buy(bakery, -1, -1);  // bakery에서 빵 3개 구매를 위해서 10000원을 냈다.
