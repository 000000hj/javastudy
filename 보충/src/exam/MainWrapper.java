...
public class MainWrapper {
  ...
  public static void q5() {
    ...
    int result=(diffA<diffB)?a:b;
    
    System.out.println(a+","+b+"중 10과 가까운 수는 "+result+"입니다.");
  ...
  public static void q7() {
    ...
    if(second<60)
    {
      System.out.println("초는"+second+"초입니다.");
    }
    else if(second<3600)
    {
      System.out.println("초는"+second/60+"분"+second%60+"초입니다.");
    }
    else
      System.out.println("초는"+second/3600+"시간"+second%3600/60+"분"+second%60+"초입니다");
	...
	public static void q9() {
	  ...
	  for(int i=2;  i<=5;i++)
	  {
	    for(int j=1;j<=9;j++)//<-------------------
	    {                                        //ㅣ 
	      System.out.println(i+"x"+j+"="+i*j);   //ㅣ
	      if(j==5&&i==5) {                       //ㅣ
	      break;//----------------------------------
	      }
	    }
	  }
	  // 위 아래 비교해보기. break 실행시 어디로 가는지 알 수 있다.
	  for(int i=2;  i<=9;i++)
    {
      for(int j=1;j<=9;j++)//<-------------------
      {                                        //ㅣ 
	   ...
	   for(int i=2;  i<=9;i++)
    {
      ...
      {                                        //ㅣ 
        System.out.println(i+"x"+j+"="+i*j);   //ㅣ
        if(j==5&&i==5) {                       //ㅣ
        break outer;//----------------------------  //for문에서 (라벨명)을 깨고 나가겠다는 의미
        }
      }
    }
