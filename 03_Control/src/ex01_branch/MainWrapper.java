...
public class MainWrapper {
  ...
  public static void ex02() {
    ...
    else if(score>=60)System.out.println("합격입니다");
    else if(score<60)System.out.println("불합격입니다.");
  ...
  /*
   * switch 문 
   * 1.지정된 표현식의 결과에 따라 분기 처리한다.(true/false 에 의한 분기 처리가 아니다.)
