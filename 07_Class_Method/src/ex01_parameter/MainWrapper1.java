...
public class MainWrapper1 {
  ...
  public static void ex05(int[]arr) {//인수가 배열1개이면 파라미터 int[]arr을 선언한다. 여기서 배열이름은 아무 이름이나 사용해도 상관없다.
    System.out.println("ex05:"+Arrays.toString(arr));
  }
  public static void ex04(String a, int b) {//문자열 인수는 파라미터 String a로 받고, 정수 인수는 int b로 받는다.
    System.out.println("ex04:"+a);
    System.out.println("ex04:"+b);
  }
  
  public static void ex03(double a, double b) {//인수가 실수 2개이면 double a , double b 를 선언한다.
