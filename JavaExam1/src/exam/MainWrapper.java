...
public class MainWrapper {
    ...
    System.out.println("모든"+3+"의 배수의 합은"+total+"입니다.");
	}
   ...
   System.out.println(gift);
	...
	public static void q9() {
		...
		for(int i=1;i<=100;i++)
		{
		   ...
		   ten=i/10;//10의 자리 구하기
		   unit=i-ten*10;//1의자리 구하기
		   
		   //10의 자리만 3의 배수인 경우
		   if(ten%3==0&&ten>0)
		   {
		     System.out.print(String.format("%s", "짝"));
		   }
		   //10의 자리만 3의 배수인 경우
		   else if((ten%3==0&&ten>0)&&unit%3==0)
       {
         System.out.print(String.format("%s", "짝"));
       }
		   
		   //일의자리만 3의 배수인 경우, 10의배수는 이제 더 볼 필요가 없기 때문에 거르기
		   if(unit%3==0&&i%10!=0)
		   {
		     System.out.print(String.format("%-3s", "짝"));
		   }
		   //걸러진 나머지는 숫자로 출력
		   else {
